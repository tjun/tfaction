...
const GCPSecretManagerSecretEnv = zod_1.z.object({
    env_name: zod_1.z.string(),
});
const GCPSecretManagerSecret = zod_1.z.object({
...
const JobConfig = zod_1.z.object({
    ...
    gcp_secret_manager: zod_1.z.optional(zod_1.z.array(GCPSecretManagerSecret)),
});
